...
import PasswordInput from "../Scomponent/PasswordInput"
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("/auth/signin", {   // i have already add axios so no need to add full url
        email,
        password,
      })
  ...
  return (
    <div className="h-screen bg-cyan-50 overflow-hidden relative">
      ...
      <div className="container h-screen flex items-center justify-center px-20 mx-auto">
        <div className="w-2/4 h-[90vh] flex items-end bg-[url('/loginpage.jpeg')] bg-cover bg-center rounded-lg p-10 z-50">
          <div>
